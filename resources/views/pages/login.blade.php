...
<!-- Mirrored from lezato.w3itexpert.com/laravel/demo/page-login by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 06 Oct 2023 09:55:40 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>GestTechImmo |  Login</title>
...
<body class="vh-100">
                        ...
                        <div class="row no-gutters">
                            <div class="col-xl-12">
                                <div class="auth-form">
                                    ...
                                    <form action="https://lezato.w3itexpert.com/laravel/demo/index">
                                        <div class="mb-3">
    ...
    ***********************************-->
    ...
    <script src="{{('assets/vendor/jquery-nice-select/js/jquery.nice-select.min.js')}}"  type="text/javascript"></script>
...
<!-- Mirrored from lezato.w3itexpert.com/laravel/demo/page-login by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 06 Oct 2023 09:55:43 GMT -->
