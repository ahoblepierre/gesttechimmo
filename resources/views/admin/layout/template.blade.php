        ...
        ***********************************-->
		<div class="nav-header">
			<a href="{{route("index.dasboard")}}" class="brand-logo">
				...
				<img  class="logo-abbr" width="200" height="56" src="{{asset("assets/images/logo-admin.png")}}" alt="">

				
				
				<img  class="brand-title" width="165" height="35" viewBox="0 0 165 35" src="{{asset("assets/images/logo-second.png")}}" alt="">
