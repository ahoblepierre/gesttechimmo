...
<div class="row page-titles">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="javascript:void(0)">Cette section est reserve a l'ajout d'une catégorie</a></li>
    </ol>
</div>
    <div class="row">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="basic-form">
                        <form action="{{route("store.category")}}" method="POST" enctype="multipart/form-data" id="formFormation">
                            @csrf
                            <div class="mb-3 row">
