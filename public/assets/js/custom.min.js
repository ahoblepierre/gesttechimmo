    ...
    var b = function () {
        ...
        o = function () {
            if (jQuery(".deznav-scroll").length > 0) {
                let a = new PerfectScrollbar(".deznav-scroll");
                a.isRtl = !1;
            }
        },
        p = function () {
            $(".btn-number").on("click", function (c) {
                c.preventDefault(),
        ...
        r = function () {
            jQuery(".dz-fullscreen").on("click", function (a) {
        ...
        u = function () {
            $(".dz-load-more").on("click", function (a) {
                a.preventDefault(),
        ...
        x = function () {
            var a = $(window).height() - 206;
            $(".chatbox .msg_card_body").css("height", a);
        },
        y = function () {
            jQuery(".dz-demo-content").length > 0 &&
